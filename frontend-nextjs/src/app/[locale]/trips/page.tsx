...
import { Button, DatePicker, Input, Popover, Tabs, Spin } from "antd"
        ...
        <div >
            <div className='container mx-auto px-4 md:px-6'>
                ...
                <div className="bg-gray-100 p-3 md:p-4 rounded-2xl mt-6 md:mt-8">
                    ...
                    <div className="flex flex-col md:flex-row gap-2 md:gap-4">
                        ...
                        <div className="flex gap-2">
                            <Popover >
                                <Button size="large" shape="round" type="default" className="flex-1 md:flex-initial">
                                    <span className="text-xs font-bold">{t('accommodation.travelers')}</span>
                                </Button>
                            </Popover>
                            <Button icon={<LuSearch size={20} />} size="large" shape="round" type="primary" className="flex-1 md:flex-initial">
                ...
                <div className="w-full mt-6 md:mt-8 mb-8 md:mb-16">
                    <Tabs defaultActiveKey="1" className="w-full" items={[
                        {
                            label: <span className="text-xs md:text-sm font-bold">{t('tabs.trips')}</span>,
                            key: '1',
                            children:
                                <div>
                        ...
                        {
                            label: <span className="text-xs md:text-sm font-bold">{t('tabs.guides')}</span>,
                            key: '2',
                            children:
                                <div>
                                    <div className="flex justify-end items-center mb-4">
